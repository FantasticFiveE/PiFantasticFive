...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await axios.post("http://localhost:3001/Frontend/login", formData, {
    ...
    <div className="futuristic-login-container">
      ...
      <div className="futuristic-login-left">
        <div className="futuristic-brand-container floating-brand">
          ...
          <p className="futuristic-brand-subtitle">Your gateway to the future. Login to access our innovative platform.</p>
        </div>
      </div>
