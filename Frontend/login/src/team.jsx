...
import Navbar from "./Navbar";   // Adjust path to where Navbar is located
import Footer from "./Footer";   // Adjust path to where Footer is located
import {
  FaFacebook,
  FaTwitter,
  FaLinkedin,
...
import "./Team.css"; // Our new futuristic/glassmorphism style
